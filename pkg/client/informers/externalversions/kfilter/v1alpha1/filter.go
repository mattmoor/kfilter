	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.KfilterV1alpha1().Filters(namespace).List(options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.KfilterV1alpha1().Filters(namespace).Watch(options)
			},
		},
		&kfilterv1alpha1.Filter{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *filterInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&kfilterv1alpha1.Filter{}, f.defaultInformer)
}
