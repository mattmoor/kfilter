...
var filtersResource = schema.GroupVersionResource{Group: "kfilter.mattmoor.io", Version: "v1alpha1", Resource: "filters"}

var filtersKind = schema.GroupVersionKind{Group: "kfilter.mattmoor.io", Version: "v1alpha1", Kind: "Filter"}
...
func (c *FakeFilters) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.Filter, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(filtersResource, c.ns, name, data, subresources...), &v1alpha1.Filter{})
