...
import (
	...
	"github.com/mattmoor/kfilter/pkg/client/clientset/versioned/scheme"
...
func NewForConfig(c *rest.Config) (*KfilterV1alpha1Client, error) {
	...
	return &KfilterV1alpha1Client{client}, nil
}

// NewForConfigOrDie creates a new KfilterV1alpha1Client for the given config and
...
func New(c rest.Interface) *KfilterV1alpha1Client {
	return &KfilterV1alpha1Client{c}
}
