...
const transformImage = "transform:image"
...
func TestReconcile(t *testing.T) {
	...
	table.Test(t, MakeFactory(func(listers *Listers, opt reconciler.Options,
		...
		return &Reconciler{
			...
			transformLister:  listers.GetTransformLister(),
			transformImage:   transformImage,
		}
	}))
}

func kf(name, namespace string, opts ...TransformOption) *kfv1alpha1.Transform {
...
func svc(kf *kfv1alpha1.Transform, opts ...v1alpha1testing.ServiceOption) *v1alpha1.Service {
	svc := resources.MakeKService(kf, transformImage)
